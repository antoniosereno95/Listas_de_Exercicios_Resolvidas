...
public class exercicio_03 {
    public static void main(String[] args){
        ...
        int cont_aprovado = 0 , cont_reprovado = 0 , conta_recuperaçao = 0;
        ...
        System.out.println("A quantidade de alunos aporvados nesse semestre foi de "+cont_aprovado+" ,\na de alunos em recuperaçao foi de "+cont_reprovado+" ,\ne a de alunos reprovados foi de "+conta_recuperaçao+" .");
